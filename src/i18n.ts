...
const en = {
  ...
  busy: 'Public demo is busy · shared AI capacity', interrupted: 'This response was interrupted.', failed: 'couldn’t respond.', stopped: 'Current turn stopped.', challenge: 'A quick verification is required to protect shared public capacity.',
...
const zh: Record<keyof typeof en, string> = {
  ...
  busy: '公共体验繁忙 · 共享 AI 容量', interrupted: '这条回复被中断了。', failed: '未能回复。', stopped: '当前回复已停止。', challenge: '为保护共享公共容量，需要进行一次快速验证。',
